...
// Quality and risk types referenced in ExecutionPhase
type QualityCriterion struct{ Name string }
type RiskFactor struct{ Name string }

// Schedule-related stubs
type Milestone struct{ Name string }
type ScheduleConstraint struct{ Name string }
type ScheduleFlexibility struct{ Level string }
...
type AblationValidation struct{}
type AblationQualityAssessment struct{}
